...
The `rchime()` function accepts [strollur](https://mothur.org/strollur/) dataset objects as inputs. Let's create a dataset object using files from [mothur's](https://mothur.org) [Miseq_SOP](https://mothur.org/wiki/miseq_sop/) example. Then we will use the *denovo* method in `rchime()` to detect and remove the chimeras from the dataset.
