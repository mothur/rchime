...
* `rchime()` detect and remove chimeras from your [strollur](https://mothur.org/strollur/) dataset object
* `rchimeReference()` detect chimeras in your sequences using a reference
